...
const imageFormats=['MOS', 'BMP', 'DNG', 'HEIF', 'WEBP', 'ARW', 'ORF', 'X3F', 'AVIF', 'CR3', 'EPS', 'RAW', '3FR', 'NEF', 'ODG', 'RAF', 'XCF', 'HEIC', 'PS', 'JPG', 'CR2', 'XPS', 'ERF', 'JFIF', 'RW2', 'JPEG', 'CRW', 'TIF', 'PNG', 'ICNS', 'PPM', 'PSD', 'ODD', 'DCR', 'TIFF', 'MRW', 'GIF', 'PEF']
...
const DownloadButton = ({ fileUrl,type }) => {
  ...
  const handleDownload = () => {
    ...
    if (type.toUpperCase() in imageFormats2){
      url="http://localhost:8000/download/uploads/"+fileUrl
    }
